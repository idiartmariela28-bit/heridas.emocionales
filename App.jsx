...
const WOUNDS_CONFIG = {
    ...
    abandono: {
        ...
        survivalDesc: "Tu sistema nervioso busca conexión de forma ansiosa. Te vuelves demandante para asegurar que el otro no se vaya.",
        color: "#db2777", // Rosa fucsia
        ...
        awareness: "Tu hambre de atención es en realidad falta de auto-apoyo. Sanar es descubrir quién eres cuando nadie te mira y aprender a ser tu propio refugio seguro.",
    ...
    humillacion: {
        ...
        survivalDesc: "Te bloqueas y absorbes el impacto. Te vuelves servicial, cargando con dolor ajeno para evitar la vergüenza.",
        color: "#9f1239", // Bordó claro
        ...
        awareness: "Te has convertido en la salvadora de todos para no mirar tu propia vergüenza. Sanar es entender que el placer no es un pecado, sino una necesidad lícita y digna de ti.",
        fear: "La Libertad de ser tú misma sin censura social.",
    ...
    traicion: {
        ...
        mask: "Controladora",
        survivalResponse: "Reaccionar",
        survivalDesc: "Modo lucha. Tomas el mando de forma dominante para anticiparte a cualquier engaño o pérdida de poder.",
        color: "#6b1d2f", // Bordó primario
        ...
        awareness: "Tu control es un escudo contra la impotencia. Confiar no es asegurar que no te fallen, sino saber que tienes la fuerza para sobrevivir si sucede.",
    ...
    injusticia: {
        ...
        mask: "Rígida",
        survivalResponse: "Paralizarse",
        survivalDesc: "Tu sistema se 'congela' en la perfección. Te vuelves fría y cuadriculada para que ninguna emoción pueda dañarte.",
        color: "#4c0519", // Bordó oscuro
...
const SCENARIOS = {
    personal: [
        ...
        { q: "Debes pedir dinero prestado por una urgencia real...", options: [{ t: "Prefiero sufrir sola antes que pedir", w: "rechazo" }, { t: "Me da pánico que me digan que no", w: "abandono" }, { t: "Me muero de la vergüenza al pedir", w: "humillacion" }, { t: "Me siento humillada al perder poder", w: "traicion" }, { t: "No debería haberme pasado esto, es un error", w: "injusticia" }, NEUTRAL_OPT] },
        ...
        { q: "Te equivocas de camino conduciendo con gente...", options: [{ t: "Me quedo muda y tensa de estrés", w: "rechazo" }, { t: "Temo que se burlen o se harten", w: "abandono" }, { t: "Me siento la más tonta del mundo", w: "humillacion" }, { t: "Culpo al GPS o a las señales", w: "traicion" }, { t: "Me enfurezco por mi falta de precisión", w: "injusticia" }, NEUTRAL_OPT] },
    ...
    pareja: [
        ...
        { q: "Tu pareja te dice que te ve muy guapa hoy...", options: [{ t: "Me siento incómoda y cambio de tema", w: "rechazo" }, { t: "Necesito que me lo repita más veces", w: "abandono" }, { t: "Lo dice por lástima o costumbre", w: "humillacion" }, { t: "Sospecho qué querrá conseguir de mí", w: "traicion" }, { t: "Analizo si mi aspecto es realmente impecable", w: "injusticia" }, NEUTRAL_OPT] },
        ...
        { q: "Propones intimidad y tu pareja dice que está cansada...", options: [{ t: "Me siento rechazada y me alejo", w: "rechazo" }, { t: "Temo que ya no le atraigo nada", w: "abandono" }, { t: "Me siento degradada y ridícula", w: "humillacion" }, { t: "Pienso que lo hace con otra", w: "traicion" }, { t: "Es injusto, yo siempre estoy disponible", w: "injusticia" }, NEUTRAL_OPT] },
        ...
        { q: "Tu pareja está muy cariñosa hoy sin motivo...", options: [{ t: "Me siento invadida con tanto contacto", w: "rechazo" }, { t: "Me relajo, pero quiero que sea eterno", w: "abandono" }, { t: "Siento que no merezco tanto afecto", w: "humillacion" }, { t: "Sospecho si ha hecho algo malo", w: "traicion" }, { t: "Analizo si este afecto es proporcional", w: "injusticia" }, NEUTRAL_OPT] },
    ...
    laboral: [
        ...
        { q: "Un compañero asciende y tú no, habiendo trabajado igual...", options: [{ t: "No encajo en esta empresa", w: "rechazo" }, { t: "Me siento dejada de lado", w: "abandono" }, { t: "Todos ven mi fracaso patente", w: "humillacion" }, { t: "Hay favoritismos y traiciones internas", w: "traicion" }, { t: "Es una injusticia meritocrática clara", w: "injusticia" }, NEUTRAL_OPT] },
        ...
        { q: "Tu jefe no te saluda al entrar hoy por la mañana...", options: [{ t: "Mejor así, menos contacto social", w: "rechazo" }, { t: "He hecho algo mal, ya no me quiere", w: "abandono" }, { t: "Soy invisible para la empresa", w: "humillacion" }, { t: "Me está ninguneando a propósito", w: "traicion" }, { t: "Es una falta de profesionalidad total", w: "injusticia" }, NEUTRAL_OPT] },
        { q: "Un colaborador comete un error grave bajo tu mando...", options: [{ t: "No le digo nada por no entrar en líos", w: "rechazo" }, { t: "Temo que si le regaño me odie", w: "abandono" }, { t: "Me siento responsable de su torpeza", w: "humillacion" }, { t: "Le vigilaré de cerca, ya no confío", w: "traicion" }, { t: "Debe haber una consecuencia justa", w: "injusticia" }, NEUTRAL_OPT] },
        ...
        { q: "Te proponen un traslado a otra ciudad...", options: [{ t: "No quiero cambiar mi entorno seguro", w: "rechazo" }, { t: "Me da miedo perder mis vínculos aquí", w: "abandono" }, { t: "Haré el ridículo en un sitio nuevo", w: "humillacion" }, { t: "Negociaré el máximo poder allá", w: "traicion" }, { t: "Analizo si es un paso justo en mi carrera", w: "injusticia" }, NEUTRAL_OPT] }
    ]
};
...
const ActionButton = ({ onClick, children, className, variant = 'primary' }) => {
    const variants = {
        primary: "bg-[#6b1d2f] text-white hover:bg-[#521321] shadow-[#6b1d2f]/10",
        secondary: "bg-slate-700 text-white hover:bg-slate-800 shadow-slate-200",
        outline: "bg-white border-2 border-slate-200 text-slate-400 hover:text-slate-900 hover:border-slate-900",
        ghost: "text-slate-400 hover:text-[#6b1d2f]",
        accent: "bg-[#fdf2f8] border-[#fbcfe8] text-[#be185d] hover:border-[#6b1d2f]"
    };
    ...
    return (
        <button
            onClick={onClick}
            className={cn(
                "p-6 rounded-[2.5rem] font-black text-xl flex items-center justify-center gap-4 transition-all active:scale-95 shadow-2xl",
                variants[variant],
                className
            )}
        >
...
const InfoCard = ({ icon: Icon, title, content, colorClass = "text-[#6b1d2f]", bgClass = "bg-white" }) => (
    <div className={cn("p-8 rounded-[2.5rem] border border-slate-100 shadow-sm space-y-4", bgClass)}>
        ...
        <p className={cn("leading-relaxed font-medium", bgClass.includes('6b1d2f') ? 'text-rose-100 text-pretty' : 'text-slate-600')}>
            {content}
        </p>
    </div>
);
...
const ProtocolStep = ({ icon: Icon, stepNum, title, desc }) => (
    <li className="flex gap-6 group">
        <div className="w-12 h-12 rounded-2xl bg-[#6b1d2f] text-white flex items-center justify-center font-black text-xl shrink-0 group-hover:scale-110 transition-transform shadow-lg">
            <Icon size={20}/>
        </div>
        <div>
...
const useEgoScan = () => {
    ...
    const processAnswer = (wound) => {
        ...
        if (step < SCENARIOS[scope].length - 1) {
            ...
            // Filtramos la opción neutral del conteo dominante para determinar la herida real de manera asertiva
            const sorted = Object.entries(counts)
                .filter(([k]) => k !== 'neutral')
                .sort((a,b)=>b[1]-a[1]);
           
            const main = sorted[0] ? sorted[0][0] : 'rechazo';
            const finalRes = {
                main,
                counts,
                date: new Date().toLocaleDateString(),
                scope: scope.charAt(0).toUpperCase() + scope.slice(1),
                allScores: Object.entries(counts)
                    .filter(([k]) => k !== 'neutral')
                    .map(([k,v])=>({ subject: WOUNDS_CONFIG[k].name, value: v }))
            };
            setResults(finalRes);
            localStorage.setItem('egoscan_ultimate_v2', JSON.stringify(finalRes));
            setView('results');
        }
    };
    ...
    const handleTest = (idx) => {
        if (idx === TEST_QUESTIONS[testStep].correct) setTestScore(prev => prev + 1);
    ...
    return {
        view, setView, scope, step, results, testScore, testStep,
        resetSession, startQuiz, processAnswer, handleTest
    };
};
            ...
            <div className="h-80 bg-slate-50 rounded-[4rem] p-8 border-2 border-slate-100 flex items-center justify-center shadow-inner relative overflow-hidden">
                <ResponsiveContainer width="100%" height="100%">
                    <RadarChart data={ego.results?.allScores}>
                        ...
                        <Radar
                            dataKey="value"
                            stroke={WOUNDS_CONFIG[ego.results?.main]?.color}
                            fill={WOUNDS_CONFIG[ego.results?.main]?.color}
                            fillOpacity={0.65}
                        />
                    </RadarChart>
                </ResponsiveContainer>
                ...
                return (
                    <div className="space-y-12 animate-fade-in">
                        ...
                        <div className="grid grid-cols-1 gap-4">
                            {[
                                { id: 'personal', label: 'Personal', icon: User, color: 'bg-slate-50 border-slate-200 text-slate-700' },
                                { id: 'pareja', label: 'Pareja', icon: Heart, color: 'bg-[#fdf2f8] border-[#fbcfe8] text-[#be185d]' },
                                { id: 'laboral', label: 'Laboral', icon: Briefcase, color: 'bg-[#fcf8f9] border-[#f3e8eb] text-[#6b1d2f]' }
                            ].map((item) => (
                            ...
                            <div className="p-6 bg-slate-50 rounded-3xl border border-slate-200 flex items-center justify-between">
                                <div className="flex items-center gap-3 text-left">
                                    ...
                                    <div>
                                        ...
                                        <div className="font-bold text-[#6b1d2f] uppercase italic leading-none">Herida de {ego.results.main}</div>
                                    </div>
                                </div>
                    ...
                    <div className="space-y-10 animate-fade-in h-auto">
                        <div className="space-y-3">
                            <div className="flex justify-between text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">
                                <span>{ego.scope}</span><span>{ego.step+1} / 10</span>
                            </div>
                            <div className="h-1.5 bg-slate-100 rounded-full overflow-hidden">
                                <div className="h-full bg-[#6b1d2f] transition-all duration-700" style={{width: `${((ego.step+1)/10)*100}%`}}></div>
                            </div>
                        </div>
                        <h2 className="text-3xl font-bold text-slate-800 leading-tight tracking-tight">{scenario.q}</h2>
                        <div className="space-y-3">
                            {scenario.options.map((opt, i) => (
                                <button key={i} onClick={()=>ego.processAnswer(opt.w)} className="w-full text-left p-6 rounded-3xl border-2 border-slate-50 bg-slate-50/30 hover:border-[#6b1d2f] hover:bg-white transition-all text-base font-bold text-slate-700 flex gap-5 items-center group shadow-sm outline-none">
                                    <span className="w-10 h-10 bg-white rounded-xl flex items-center justify-center text-xs font-black text-slate-300 group-hover:bg-[#6b1d2f] group-hover:text-white transition-all shadow-inner">{String.fromCharCode(65+i)}</span>
                                    {opt.t}
                                </button>
                            ))}
                        </div>
                ...
                return (
                    <div className="space-y-10 animate-fade-in text-center h-auto">
                        <div className="space-y-3">
                            ...
                            <div className="flex flex-wrap justify-center gap-2 mt-4">
                                <span className="px-4 py-1.5 bg-slate-100 text-slate-900 rounded-full text-xs font-black uppercase tracking-widest flex items-center gap-2 border border-slate-200">
                                    <Shield size={14}/> Máscara: {config.mask}
                                </span>
                                <span className={cn(
                                    "px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-widest flex items-center gap-2 border",
                                    config.survivalResponse === 'Huir' ? "bg-rose-50 text-[#be185d] border-rose-200" :
                                    config.survivalResponse === 'Paralizarse' ? "bg-slate-100 text-slate-700 border-slate-300" :
                                    "bg-pink-50 text-[#db2777] border-pink-200"
                                )}>
                                    {config.survivalResponse === 'Huir' ? <ZapOff size={14}/> :
                                     config.survivalResponse === 'Paralizarse' ? <Snowflake size={14}/> : <Flame size={14}/>}
                        ...
                        <div className="grid grid-cols-1 gap-4 pb-12">
                            <ActionButton onClick={() => ego.setView('longExplanation')} variant="secondary">
                                <BookOpen size={24}/> Análisis Profundo
                            </ActionButton>
                            <ActionButton onClick={() => ego.setView('awareness')}>
            ...
            case 'longExplanation':
                return (
                    <div className="space-y-10 animate-fade-in pb-16 h-auto">
                        <button onClick={()=>ego.setView('results')} className="text-slate-400 hover:text-slate-900 flex items-center gap-2 text-xs font-black uppercase tracking-widest transition-colors">
                            <ArrowLeft size={18}/> Volver
                        </button>
                        <h2 className="text-5xl font-black text-slate-900 uppercase italic leading-none text-balance">Anatomía de la {config.name}</h2>
                        ...
                        <div className="space-y-8">
                            <div className="p-10 bg-slate-50 rounded-[4rem] border-2 border-slate-100 space-y-8 shadow-sm text-pretty">
                                <div className="flex gap-6">
                                    <Quote size={64} className="text-[#fbcfe8] shrink-0 opacity-50"/>
                                    <p className="text-slate-700 text-xl leading-relaxed italic font-bold">"{config.longDesc}"</p>
                                </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6 text-center">
                                    <div className="p-8 bg-white rounded-[2.5rem] border border-slate-100 shadow-sm space-y-3">
                                        <div className="flex items-center justify-center gap-2 text-red-500 font-black uppercase text-xs tracking-widest"><AlertCircle size={16}/> Temor</div>
                                        <div className="text-2xl font-black text-slate-800 leading-tight">{config.fear}</div>
                                    </div>
                                    <div className="p-8 bg-white rounded-[2.5rem] border border-slate-100 shadow-sm space-y-3">
                                        <div className="flex items-center justify-center gap-2 text-emerald-500 font-black uppercase text-xs tracking-widest"><CheckCircle size={16}/> Sanación</div>
                                        <div className="text-2xl font-black text-slate-800 leading-tight">{config.healingKey}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-10 text-pretty">
                            <section className="p-10 border-2 border-[#fbcfe8] rounded-[4rem] bg-[#fdf2f8] space-y-6 border-l-8 border-l-[#be185d]">
                                ...
                                <p className="text-slate-600 text-lg font-medium leading-relaxed">
                                    Cuando sientas la activación biológica, detente y etiqueta:
                            ...
                            <section className="p-10 bg-slate-900 text-white rounded-[4rem] space-y-10 shadow-2xl relative overflow-hidden">
                                ...
                                <div className="space-y-6 relative"><h4 className="font-black text-[#fbcfe8] flex items-center gap-3 tracking-[0.2em] uppercase text-sm"><Target size={24}/> A de Acción Alternativa</h4><p className="text-rose-100 text-lg font-medium leading-relaxed">Reprogramación en 8 pasos:</p></div>
                                <ul className="space-y-6 relative text-left">
                                    <ProtocolStep icon={Clock} stepNum={1} title="Pausa de los 90s" desc="Espera a que el 'disparo' químico se disipe." />
                                    <ProtocolStep icon={Wind} stepNum={2} title="Respiración Coherente" desc="Señal biológica de seguridad al corazón (4s)." />
                                    <ProtocolStep icon={Brain} stepNum={3} title="Etiquetado Cognitivo" desc="Activa tu Corteza Prefrontal." />
                                    ...
                                    <ProtocolStep icon={UserCheck} stepNum={7} title="Sostén de la Sensación" desc="Tolera la incomodidad de lo nuevo." />
                                    <ProtocolStep icon={Award} stepNum={8} title="Anclaje de Victoria" desc="Celebra tu consciencia." />
                                </ul>
                            </section>
                        </div>
                ...
                return (
                    <div className="space-y-12 animate-fade-in pb-16 h-auto">
                        <div className="space-y-4 text-center">
                            ...
                            <p className="text-slate-500 font-medium text-lg italic">¿Sabes desarmar tu mecanismo de {config.survivalResponse}?</p>
                        </div>
                        <div className="p-10 border-4 border-slate-50 rounded-[4rem] bg-slate-50/20 space-y-10 shadow-inner">
                            ...
                            <div className="grid grid-cols-1 gap-4">
                                {tq.options.map((opt, i) => (
                                    <button key={i} onClick={()=>ego.handleTest(i)} className="p-6 bg-white border-2 border-slate-100 rounded-3xl text-left text-lg font-bold text-slate-600 hover:border-[#6b1d2f] hover:text-[#6b1d2f] transition-all outline-none shadow-sm hover:shadow-md">{opt}</button>
                                ))}
                            </div>
                        </div>
                    </div>
            ...
            case 'testResults':
                return (
                    <div className="space-y-10 animate-fade-in text-center pb-20 h-auto">
                        <div className="w-40 h-40 bg-[#6b1d2f] rounded-full mx-auto flex items-center justify-center text-white shadow-2xl shadow-[#6b1d2f]/20"><Award size={80} /></div>
                        <h2 className="text-5xl font-black text-slate-900 uppercase italic leading-none">¡Maestría Integrada!</h2>
                        <p className="text-2xl text-slate-500 font-bold">Has dominado {ego.testScore} de {TEST_QUESTIONS.length} conceptos.</p>
                        <div className="p-10 bg-slate-900 text-white rounded-[4rem] shadow-2xl relative overflow-hidden group">
                            <Sparkles className="absolute -top-10 -right-10 text-white/10 w-48 h-48 rotate-45 transition-transform duration-1000" />
                            <p className="relative text-2xl font-bold italic text-rose-100 leading-relaxed text-pretty font-medium italic">"La emoción es la brújula que apunta hacia tu herida, pero el registro es el mapa que te guía hacia tu libertad."</p>
                        </div>
                        <div className="p-8 bg-[#fdf2f8] border border-[#fbcfe8] rounded-3xl text-[#be185d] font-bold text-lg italic shadow-sm text-pretty">Recuerda: No registramos para controlar, sino para no ser controladas por lo desconocido.</div>
        ...
        <div className="w-full max-w-2xl mx-auto min-h-screen bg-white flex flex-col font-sans border-x border-slate-50 shadow-2xl overflow-x-hidden">
            ...
            <footer className="p-10 text-center border-t border-slate-50 bg-slate-50/30">
                <p className="text-[10px] text-slate-300 font-black uppercase tracking-[0.5em]">
                    EgoScan Mastery • Bio-Consciencia • 2026
                </p>
            </footer>
        </div>
    );
